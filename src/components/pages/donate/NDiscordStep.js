        ...
        fetch('/api/discordprofile/'+username+'/'+tag).then(res => {
            res.json().then(res => {
                ...
                if(res.status === 'success') {
                    ...
                    setPfpUrl(res.avatarURL);
                    setError(false);
                }
                else {
                    props.setDiscordId('');
                    setNickname(defaultNickname);
                    setPfpUrl(defaultDiscordPic);
                    setError(true);
                }
            })
